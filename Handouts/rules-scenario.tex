...
%%
%% Most of the material presented here, especially in the Getting
%% Started and Items Etc. sections, is taken for granted by many
%% players.  This has two major implications:
%%
...
\SORT{GM}{alpha<}{\parsealphaP}{\EVERY{GM}{}}{\ifcredit\MYplayer, \fi}and
...
%\paragraph{Doors and Locks:} In-game locks will have a lock number
%printed on the card.  To open the lock, you need a key with the same
%number.  If a lock is closed, assume it is locked.
