...
%% or \ambiguous, as correct for the character.
%% \mfnn{<masculine>}{<feminine>}{<neutral>}{<neuter>} will produce
%% the correct form based on the current value of \MYsex (\ambiguous
%% will lead to <masculine>/<feminine>).  \mfnn should only be used
%% within the scope of a Char macro.  \mf{<masc>}{<fem>} works just
%% like \mfnn with the <neutral> <neuter> args left blank.
%%
...
\newcommand{\mfnn}[4]{\ifcase\MYsex#1\or#2\or#3\or#4\else#1/#2\fi}
